...
<head>
  ...
  <title>Emdee Teka Teki Salah</title>
  <!-- plugins:css -->
  ...
  <style type="text/css">
    ...
    body {
      background: url("<?php echo base_url(); ?>/assets/images/hadiah/bg_tts.jpg") no-repeat center center fixed;
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div align="center" style="padding-top: 0px">
          <a href="<?php echo base_url(); ?>/C_Mysterybox/listHadiahNGY" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
        </div>
        <div class="content-wrapper" style="padding-top: 100px;">
          <div class="row">

            <iframe width="500" height="500" style="padding:5px 0px 0 5px; margin:auto; display:block" frameborder="0" src="https://crosswordlabs.com/embed/teka-teki-salah-4"></iframe>
  ...
  <script type="text/javascript">
      function suwal(id, randRow) {
        $.ajax({
            ...
            dataType: 'json',
            data    : {id : id},
            url     : "<?php echo base_url('C_Mysterybox/getHadiahNGY'); ?>",
            success : function(prize) {
              if (prize.jumlah > 0) {
                Swal.fire({
                  title: 'Selamat Emdeers, kamu dapat ...',
                  text: prize.nama_hadiah,
                  imageUrl: '<?php echo base_url(); ?>/assets/images/hadiah/NGY/'+prize.gambar,
                  imageWidth: 250,
                  imageHeight: 250,
                  ...
                  if (result.isConfirmed) {
                    $("#mb"+randRow).attr('src','<?php echo base_url(); ?>/assets/images/hadiah/NGY/'+prize.gambar);
                    $("#btn"+randRow).hide();
                ...
                Swal.fire({
                  ...
                  text: prize.nama_hadiah,
                  imageUrl: '<?php echo base_url(); ?>/assets/images/hadiah/NGY/mb.png',
                  imageWidth: 250,
                  imageHeight: 250,
                  confirmButtonColor: '#3085d6',
                  confirmButtonText: 'Ok'
                  ...
                  if (result.isConfirmed) {
                    $("#mb"+randRow).attr('src','<?php echo base_url(); ?>/assets/images/hadiah/NGY/mb.png');
                    $("#btn"+randRow).hide();
      ...
      function minKuota(id) {
        ...
        $.ajax({
          method  : 'POST',
          data    : {id:id},
          url     : "<?php echo base_url('C_Mysterybox/minKuotaNGY'); ?>"
        });
      }
  </script>
  <!-- plugins:js -->
