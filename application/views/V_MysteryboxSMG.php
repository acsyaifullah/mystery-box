    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div align="center" style="padding-top: 0px">
          <a href="<?php echo base_url(); ?>/C_Mysterybox/listHadiahSMG" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 d-flex justify-content-center">
                      <div class="wrapper text-center">
                        ...
                        <p class="card-description"><img src="<?php echo base_url(); ?>/assets/images/hadiah/SMG/mb.png" width="250px" id="mb<?php echo $randRow ?>"></p>
  ...
  <script type="text/javascript">
      function suwal(id, randRow) {
        $.ajax({
            ...
            dataType: 'json',
            data    : {id : id},
            url     : "<?php echo base_url('C_Mysterybox/getHadiahSMG'); ?>",
            success : function(prize) {
              if (prize.jumlah > 0) {
                Swal.fire({
                  title: 'Selamat Emdeers, kamu dapat ...',
                  text: prize.nama_hadiah,
                  imageUrl: '<?php echo base_url(); ?>/assets/images/hadiah/SMG/'+prize.gambar,
                  imageWidth: 250,
                  imageHeight: 250,
                  ...
                  if (result.isConfirmed) {
                    $("#mb"+randRow).attr('src','<?php echo base_url(); ?>/assets/images/hadiah/SMG/'+prize.gambar);
                    $("#btn"+randRow).hide();
                ...
                Swal.fire({
                  ...
                  text: prize.nama_hadiah,
                  imageUrl: '<?php echo base_url(); ?>/assets/images/hadiah/SMG/mb.png',
                  imageWidth: 250,
                  imageHeight: 250,
                  confirmButtonColor: '#3085d6',
                  confirmButtonText: 'Ok'
                  ...
                  if (result.isConfirmed) {
                    $("#mb"+randRow).attr('src','<?php echo base_url(); ?>/assets/images/hadiah/SMG/mb.png');
                    $("#btn"+randRow).hide();
      ...
      function minKuota(id) {
        ...
        $.ajax({
          method  : 'POST',
          data    : {id:id},
          url     : "<?php echo base_url('C_Mysterybox/minKuotaSMG'); ?>"
        });
      }
  </script>
  <!-- plugins:js -->
