                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                            ...
                            Ubah</a>
                            <a style="color: black" href="<?php echo base_url('C_Mysterybox/delHadiahBLT/'.$value->idhadiah); ?>" class="btn btn-danger">Hapus</a>
                          </td>
                      </tr>
                      <?php } ?>
                    </tbody>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#formAddHadiah').submit(function(e) {
          e.preventDefault();
          $.ajax({
              url         : '<?php echo base_url('C_Mysterybox/addHadiahBLT') ?>',
              type        : 'POST',
      ...
      $('#formUpdHadiah').submit(function(e){
          e.preventDefault();
          $.ajax({
              url         : '<?php echo base_url('C_Mysterybox/updHadiahBLT') ?>',
              type        : 'POST',
              data        : new FormData(this),
              processData : false,
              contentType : false,
