                  ...
                  <table id="order-listing" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td><img class="imghadiah" src="<?php echo base_url('/assets/images/hadiah/SMG/'.$value->gambar); ?>"></td>
                          <td>
                            ...
                            Ubah</a>
                            <a style="color: black" href="<?php echo base_url('C_Mysterybox/delHadiahSMG/'.$value->idhadiah); ?>" class="btn btn-danger">Hapus</a>
                          </td>
                      </tr>
                      <?php } ?>
                    </tbody>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#formAddHadiah').submit(function(e) {
          e.preventDefault();
          $.ajax({
              url         : '<?php echo base_url('C_Mysterybox/addHadiahSMG') ?>',
              type        : 'POST',
      ...
      $(document).on("click", '.upd', function() {
          ...
          $(".gambar").attr('src', '<?php echo base_url("assets/images/hadiah/SMG/") ?>'+$(this).data('gambar'));
      });

      $('#formUpdHadiah').submit(function(e){
          e.preventDefault();
          $.ajax({
              url         : '<?php echo base_url('C_Mysterybox/updHadiahSMG') ?>',
              type        : 'POST',
              data        : new FormData(this),
              processData : false,
              contentType : false,
